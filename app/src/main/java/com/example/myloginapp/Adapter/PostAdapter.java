...
import com.example.myloginapp.CommentsActivity;
...
//-- Post Adapter --  had l class hiya lmass2ola 3la les actions kamlin dyal l posts
...
public class PostAdapter  extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PostViewHolder holder, int position) {
        ...
        //hna lamcha l user 7ta wrk 3la l tsswira dyal lcomment f post
        ...
        // --------------had l commentaire li t7t dyal labgha l user ym7i lpost dyalo knti glti liya 7ydo--------
/*
